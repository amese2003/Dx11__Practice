...
{
	vector<VertexTextureData> vec;
	vec.resize(4);

	vec[0].position = Vec3(-0.5f, -0.5f, 0.f);
	vec[0].uv = Vec2(0.f, 1.f);
	vec[1].position = Vec3(-0.5f, 0.5f, 0.f);
	vec[1].uv = Vec2(0.f, 0.f);
	vec[2].position = Vec3(0.5f, -0.5f, 0.f);
	vec[2].uv = Vec2(1.f, 1.f);
	vec[3].position = Vec3(0.5f, 0.5f, 0.f);
	vec[3].uv = Vec2(1.f, 0.f);
	geometry->SetVertices(vec);
